import{$ as e,At as t,Ft as n,G as r,J as i,Q as a,Tt as o,Y as s,Z as c,bt as l,et as u,ft as d,lt as f,nt as p,rt as m,ut as h,wt as g,xt as _,y as v,yt as ee,z as te}from"./chunks/framework.DliCx9om.js";var y={nodes:[{id:`1b5c9a513992802e`,type:`group`,x:-380,y:140,width:280,height:180,label:`File Info`},{id:`fe9b7a0bce528584`,type:`group`,x:-320,y:-320,width:220,height:180,label:`Server Info`},{id:`b49169aebac7e5df`,type:`group`,x:360,y:-30,width:340,height:100,label:`Sub-Keys`},{id:`a5d52cd03f802a4a`,type:`text`,text:`<p>File Content</p>
...
`,lt=class extends b{_preventionContainer;preventMt=!1;DM;preventMistouch={initialX:0,initialY:0,lastX:0,lastY:0,record:!1};get preventionContainer(){if(!this._preventionContainer)throw x;return this._preventionContainer}constructor(...e){super(...e);let t=document.createElement(`div`);t.className=`JCV-prevention-banner JCV-border-shadow-bg`,t.textContent=this.options.mistouchPreventerBannerText??`Click on to unlock.`,this.DM=this.container.get(E),this._preventionContainer=document.createElement(`div`),this._preventionContainer.className=`JCV-prevention-container JCV-hidden JCV-full JCV-flex-center`,S(this._preventionContainer,ct),this._preventionContainer.appendChild(t),this.DM.data.container.appendChild(this._preventionContainer),this.options.preventMistouchAtStart&&this.startPrevention(),window.addEventListener(`pointerdown`,this.onPointerDown),window.addEventListener(`pointermove`,this.onPointerMove),window.addEventListener(`pointerup`,this.onPointerUp),this.augment({endMistouchPrevention:this.endPrevention,startMistouchPrevention:this.startPrevention}),this.onDispose(this.dispose)}onPointerDown=e=>{let t=this.DM.data.container.getBoundingClientRect();e.clientX<t.left||e.clientX>t.right||e.clientY<t.top||e.clientY>t.bottom?this.preventMt||this.startPrevention():this.preventMt&&(this.preventMistouch.initialX=e.clientX,this.preventMistouch.initialY=e.clientY,this.preventMistouch.lastX=e.clientX,this.preventMistouch.lastY=e.clientY,this.preventMistouch.record=!0)};onPointerMove=e=>{this.preventMistouch.record&&(this.preventMistouch.lastX=e.clientX,this.preventMistouch.lastY=e.clientY)};onPointerUp=()=>{this.preventMistouch.record&&(this.preventMistouch.record=!1,Math.abs(this.preventMistouch.lastX-this.preventMistouch.initialX)+Math.abs(this.preventMistouch.lastY-this.preventMistouch.initialY)<5&&this.endPrevention())};startPrevention=()=>{this.preventionContainer.classList.remove(`JCV-hidden`),this.DM.data.container.classList.add(`JCV-numb`),this.preventMt=!0};endPrevention=()=>{this.preventMt=!1,this.preventionContainer.classList.add(`JCV-hidden`),setTimeout(()=>this.DM.data.container.classList.remove(`JCV-numb`),50)};dispose=()=>{window.removeEventListener(`pointerdown`,this.onPointerDown),window.removeEventListener(`pointermove`,this.onPointerMove),window.removeEventListener(`pointerup`,this.onPointerUp),this.preventionContainer.remove(),this._preventionContainer=void 0}},ut=[`innerHTML`],dt=p({__name:`Viewer`,props:{modules:{},canvas:{default:()=>({})},attachments:{},options:{default:()=>({})},isPrerendering:{type:Boolean,default:!1},theme:{}},async setup(e,{expose:r}){let i,a,o=l(`viewerRef`),s,u=m(),p=e.isPrerendering?([i,a]=g(()=>$e({attachments:e.attachments,canvas:e.canvas,...e.options})),i=await i,a(),i):``,v=ee();r({viewer:s});function y(e){return({container:n,content:r,node:i,onBeforeUnmount:a,onActive:o,onLoseActive:s})=>{let c=te({render:()=>e(t({content:r,node:i,onActive:o,onLoseActive:s}))});c._context=u.appContext,c.mount(n),a.subscribe(c.unmount)}}return _(()=>e.theme,e=>s?.changeTheme(e)),_(()=>({attachments:e.attachments,canvas:e.canvas}),({canvas:e,attachments:t})=>s?.load({attachments:t,canvas:e})),f(()=>{if(!o.value)return;let t=[`text`,`markdown`,`link`,`audio`,`image`,`video`],n={};for(let e of t){let t=v[e];t&&(n[e]=y(t))}s=new Qe(Object.assign(e.options,{attachments:e.attachments,canvas:e.canvas,container:o.value,nodeComponents:n,theme:e.theme}),e.modules)}),h(()=>{s?.dispose(),s=void 0}),(e,t)=>(d(),c(`section`,{ref_key:`viewerRef`,ref:o,innerHTML:n(p),style:{"max-height":`100vh`,"max-width":`100vw`}},null,8,ut))}}),ft=p({__name:`Canvas`,props:{canvas:{}},setup(e){let{isDark:t}=v();return(i,a)=>(d(),s(r,null,{default:o(()=>[u(n(dt),{options:{loading:`lazy`,minimapCollapsed:!0,preventMistouchAtStart:!0},class:`canvas-viewer`,modules:[n(st),n(lt),n(at)],theme:n(t)?`dark`:`light`,canvas:e.canvas,isPrerendering:n(!1)},null,8,[`modules`,`theme`,`canvas`,`isPrerendering`])]),_:1}))}}),pt=JSON.parse(`{"title":"Client-Side Encryption v2","description":"","frontmatter":{},"headers":[],"relativePath":"deep-dive/modules/encryption.md","filePath":"en/deep-dive/modules/encryption.md","lastUpdated":1788830168000}`),mt=p({name:`deep-dive/modules/encryption.md`,setup(t){return(t,r)=>(d(),c(`div`,null,[r[0]||=i(`h1`,{id:`client-side-encryption-v2`,tabindex:`-1`},[e(`Client-Side Encryption v2 `),i(`a`,{class:`header-anchor`,href:`#client-side-encryption-v2`,"aria-label":`Permalink to “Client-Side Encryption v2”`},`​`)],-1),r[1]||=i(`p`,null,[e(`The plugin uploads encrypted files to remote, download and decrypt back to local. This document specifies the encryption algorithm implementation in the `),i(`code`,null,`Encryption`),e(` module.`)],-1),r[2]||=i(`p`,null,`Encryption implementation in this module welcomes volunteer auditing.`,-1),u(ft,{canvas:n(y)},null,8,[`canvas`]),r[3]||=a("",53)]))}});export{pt as __pageData,mt as default};