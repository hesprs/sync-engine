import{$ as e,Ct as t,Dt as n,J as r,Mt as i,Q as a,R as o,St as s,W as c,X as l,Z as u,_t as d,ct as f,lt as p,nt as m,q as h,tt as g,ut as _,v as ee,vt as te,yt as v}from"./chunks/framework.Cq50P25D.js";var y={nodes:[{id:`1b5c9a513992802e`,type:`group`,x:-380,y:140,width:280,height:180,label:`File Info`},{id:`fe9b7a0bce528584`,type:`group`,x:-320,y:-320,width:220,height:180,label:`Server Info`},{id:`b49169aebac7e5df`,type:`group`,x:360,y:-30,width:340,height:100,label:`Sub-Keys`},{id:`a5d52cd03f802a4a`,type:`text`,text:`<p>File Content</p>
...
`,it=class extends b{_preventionContainer;preventMt=!1;DM;preventMistouch={initialX:0,initialY:0,lastX:0,lastY:0,record:!1};get preventionContainer(){if(!this._preventionContainer)throw x;return this._preventionContainer}constructor(...e){super(...e);let t=document.createElement(`div`);t.className=`JCV-prevention-banner JCV-border-shadow-bg`,t.textContent=this.options.mistouchPreventerBannerText??`Click on to unlock.`,this.DM=this.container.get(D),this._preventionContainer=document.createElement(`div`),this._preventionContainer.className=`JCV-prevention-container JCV-hidden JCV-full JCV-flex-center`,S(this._preventionContainer,rt),this._preventionContainer.appendChild(t),this.DM.data.container.appendChild(this._preventionContainer),this.options.preventMistouchAtStart&&this.startPrevention(),window.addEventListener(`pointerdown`,this.onPointerDown),window.addEventListener(`pointermove`,this.onPointerMove),window.addEventListener(`pointerup`,this.onPointerUp),this.augment({endMistouchPrevention:this.endPrevention,startMistouchPrevention:this.startPrevention}),this.onDispose(this.dispose)}onPointerDown=e=>{let t=this.DM.data.container.getBoundingClientRect();e.clientX<t.left||e.clientX>t.right||e.clientY<t.top||e.clientY>t.bottom?this.preventMt||this.startPrevention():this.preventMt&&(this.preventMistouch.initialX=e.clientX,this.preventMistouch.initialY=e.clientY,this.preventMistouch.lastX=e.clientX,this.preventMistouch.lastY=e.clientY,this.preventMistouch.record=!0)};onPointerMove=e=>{this.preventMistouch.record&&(this.preventMistouch.lastX=e.clientX,this.preventMistouch.lastY=e.clientY)};onPointerUp=()=>{this.preventMistouch.record&&(this.preventMistouch.record=!1,Math.abs(this.preventMistouch.lastX-this.preventMistouch.initialX)+Math.abs(this.preventMistouch.lastY-this.preventMistouch.initialY)<5&&this.endPrevention())};startPrevention=()=>{this.preventionContainer.classList.remove(`JCV-hidden`),this.DM.data.container.classList.add(`JCV-numb`),this.preventMt=!0};endPrevention=()=>{this.preventMt=!1,this.preventionContainer.classList.add(`JCV-hidden`),setTimeout(()=>this.DM.data.container.classList.remove(`JCV-numb`),50)};dispose=()=>{window.removeEventListener(`pointerdown`,this.onPointerDown),window.removeEventListener(`pointermove`,this.onPointerMove),window.removeEventListener(`pointerup`,this.onPointerUp),this.preventionContainer.remove(),this._preventionContainer=void 0}},at=[`innerHTML`],ot=g({__name:`Viewer`,props:{modules:{},canvas:{default:()=>({})},attachments:{},options:{default:()=>({})},isPrerendering:{type:Boolean,default:!1},theme:{}},async setup(e,{expose:t}){let r,a,c=te(`viewerRef`),u,h=m(),g=e.isPrerendering?([r,a]=s(()=>Je({attachments:e.attachments,canvas:e.canvas,...e.options})),r=await r,a(),r):``,ee=d();t({viewer:u});function y(e){return({container:t,content:r,node:i,onBeforeUnmount:a,onActive:s,onLoseActive:c})=>{let l=o({render:()=>e(n({content:r,node:i,onActive:s,onLoseActive:c}))});l._context=h.appContext,l.mount(t),a.subscribe(l.unmount)}}return v(()=>e.theme,e=>u?.changeTheme(e)),v(()=>({attachments:e.attachments,canvas:e.canvas}),({canvas:e,attachments:t})=>u?.load({attachments:t,canvas:e})),f(()=>{if(!c.value)return;let t=[`text`,`markdown`,`link`,`audio`,`image`,`video`],n={};for(let e of t){let t=ee[e];t&&(n[e]=y(t))}u=new qe(Object.assign(e.options,{attachments:e.attachments,canvas:e.canvas,container:c.value,nodeComponents:n,theme:e.theme}),e.modules)}),p(()=>{u?.dispose(),u=void 0}),(e,t)=>(_(),l(`section`,{ref_key:`viewerRef`,ref:c,innerHTML:i(g),style:{"max-height":`100vh`,"max-width":`100vw`}},null,8,at))}}),st=g({__name:`Canvas`,props:{canvas:{}},setup(n){let{isDark:a}=ee();return(o,s)=>(_(),r(c,null,{default:t(()=>[e(i(ot),{options:{loading:`lazy`,minimapCollapsed:!0,preventMistouchAtStart:!0},class:`canvas-viewer`,modules:[i(nt),i(it),i(et)],theme:i(a)?`dark`:`light`,canvas:n.canvas,isPrerendering:i(!1)},null,8,[`modules`,`theme`,`canvas`,`isPrerendering`])]),_:1}))}}),ct=JSON.parse(`{"title":"Client-side Encryption v2","description":"","frontmatter":{},"headers":[],"relativePath":"deep-dive/modules/encryption.md","filePath":"en/deep-dive/modules/encryption.md","lastUpdated":1786765080000}`),lt=g({name:`deep-dive/modules/encryption.md`,setup(t){return(t,n)=>(_(),l(`div`,null,[n[0]||=h(`h1`,{id:`client-side-encryption-v2`,tabindex:`-1`},[a(`Client-side Encryption v2 `),h(`a`,{class:`header-anchor`,href:`#client-side-encryption-v2`,"aria-label":`Permalink to “Client-side Encryption v2”`},`​`)],-1),n[1]||=h(`p`,null,[a(`The plugin uploads encrypted files to remote, download and decrypt back to local. This document specifies the encryption algorithm implementation in the `),h(`code`,null,`Encryption`),a(` module.`)],-1),n[2]||=h(`p`,null,`Encryption implementation in this module welcomes volunteer auditing.`,-1),e(st,{canvas:i(y)},null,8,[`canvas`]),n[3]||=u("",53)]))}});export{ct as __pageData,lt as default};